...
namespace UnityBase.GridSystem
{
    ...
    public sealed class TileGrid<T>
    {
        ...
        public int Width => _gridEntity?.Width ?? 0;
        public int Height => _gridEntity?.Height ?? 0;
        public float NodeSize => _gridEntity?.NodeSize ?? 1;
        public float3 Padding => _gridEntity?.Padding ?? float3.zero;
