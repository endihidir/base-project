...
public class PipeMeshGenerator : MonoBehaviour
{
    ...
    [ReadOnly] [SerializeField] private MeshFilter _meshFilter;
    [ReadOnly] [SerializeField] private MeshRenderer _meshRenderer;
    [ReadOnly] [SerializeField] private MeshCollider _meshCollider;
    
    
    [ReadOnly] [SerializeField] private Vector3[] _vertices;
    [ReadOnly] [SerializeField] private int[] _triangles;
    [ReadOnly] [SerializeField] private Mesh _generatedMesh;
    [ReadOnly] [SerializeField] private Transform _lastPointT;
    [ReadOnly] [SerializeField] private bool _isDrag;
